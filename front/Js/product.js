...
.then(function(kanap) {
  ...
  // setAttribute ajoute "src" et "alt", avec comme valeur l'image et le texte alt de l'api
...
.catch ((error) => {
  alert('Nous rencontrons actuellement un probléme au niveau du serveur') + error
}); 
